...
module.exports = {
    ...
    execute: async (message, args, client, prefix) => {
        ...
        if (pages.length <= 1) {
            ...
            let previousbut = new ButtonBuilder().setCustomId("Previous").setEmoji('1074729179452555314').setStyle(ButtonStyle.Secondary);

            let nextbut = new ButtonBuilder().setCustomId("Next").setEmoji('1074729175132409896').setStyle(ButtonStyle.Secondary);

            let stopbut = new ButtonBuilder().setCustomId("Stop").setEmoji('1074372187454189609').setStyle(ButtonStyle.Secondary);
