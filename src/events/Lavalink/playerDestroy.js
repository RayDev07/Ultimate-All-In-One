...
module.exports = async (client, player) => {
	...
	let pausebut = new ButtonBuilder().setCustomId(`pause_but_${guild.id}`).setEmoji('1074666147640791081').setStyle(ButtonStyle.Secondary).setDisabled(false);

	let lowvolumebut = new ButtonBuilder().setCustomId(`lowvolume_but_${guild.id}`).setEmoji('1074666395855507558').setStyle(ButtonStyle.Secondary).setDisabled(false);

	let highvolumebut = new ButtonBuilder().setCustomId(`highvolume_but_${guild.id}`).setEmoji('1074666382215614485').setStyle(ButtonStyle.Secondary).setDisabled(false);

	let previousbut = new ButtonBuilder().setCustomId(`previous_but_${guild.id}`).setEmoji('1074373035416625223').setStyle(ButtonStyle.Secondary).setDisabled(false);

	let skipbut = new ButtonBuilder().setCustomId(`skipbut_but_${guild.id}`).setEmoji('1074372912255090840').setStyle(ButtonStyle.Secondary).setDisabled(false);
